''' Set of libraries to create RSA addresses'''
import codecs
import hashlib


class AddressBitcoin(object):
    ''' Class to make bitcoin addresses or validate them'''

    def base58(self, address_hex):
        '''This method create a address from hex to base58, i.e. convert
        the address to type base58check valid '''
